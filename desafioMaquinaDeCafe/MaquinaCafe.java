...
public class MaquinaCafe {
    ...
    void fazercafe(int quantidadedeacucar) {
        if (acucarDisponivel < quantidadedeacucar) {
            System.out.println("Não tem açucar suficiente para fazer o seu café");
        } else {
            System.out.println("fazendo café com " + quantidadedeacucar + "g de açúcar.");
        }
    }
}